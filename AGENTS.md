...
## Status
2026-09-04: клиентская совместимость с ядром 0.1.2-rc.1 исправлена и покрыта регрессионным тестом (issue #1). Production-проверка ожидает стабилизации production dsh-web (рестарт-луп чужого плагина dshhub-market вне задачи) и ок владельца на deploy.
